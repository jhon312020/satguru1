...
class Home_Model extends CI_Model
{
	...
	function add_hotel($left_ban1,$country,$city,$hotelname,$starrating,$address,$postalcode,$contactno,$faxno,$checkintime,$checkouttime,$hoteldesc,$avarageprice,$createdby,$contractfrom,$contractto,$directorsales,$salespersonname,$salesno,$salesemail,$extranetpersonname,$extranetnumber,$extranetemail,$hoteldescmore,$internetfacility,$carparking,$sports,$status,$geo)
	{
		$data = array('FrontPgImage'=>$left_ban1,'Country'=>$country,'City'=>$city,'HotelName'=>$hotelname,'StarRating'=>$starrating,'Address'=>$address,'PostalCode'=>$postalcode,'ContactNo'=>$contactno,'FaxNo'=>$faxno,'checkintime'=>$checkintime,'checkouttime'=>$checkouttime,'HotelDesc'=>$hoteldesc,'AvgPrice'=>$avarageprice,'createdby'=>'admin','contractfrom'=>$contractfrom,'contractto'=>$contractto,'directorsales'=>$directorsales,'salespersonname'=>$salespersonname,'salesno'=>$salesno,'salesemail'=>$salesemail,'extranetpersonname'=>$extranetpersonname,'extranetnumber'=>$extranetnumber,'extranetemail'=>$extranetemail,'hoteldescmore'=>$hoteldescmore,'internetfacility'=>$internetfacility,'carparking'=>$carparking,'sports'=>$sports,'status'=>'1','geo'=>$geo);
