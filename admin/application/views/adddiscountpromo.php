  ...
  <div id="main">
    <div class="container-fluid">
      ...
      <div class="box box-color box-bordered red">
        ...
        <form action="<?php echo WEB_URL_ADMIN ?>admin/addnewdiscount/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>/<?php echo $this->uri->segment(5);?>" method="POST" class='form-horizontal form-validate' id="bb" enctype="multipart/form-data">
           ...
           <h5>B. %Discount</h5>
             ...
             <div class="control-group">
              ...
              <div class="controls"> From
                <input type='text' id="discountfrom" name="discountfrom"  class="input-xlarge datepick" style="width:50px;" data-rule-required="true">&nbsp;
               Till&nbsp;
                <input type='text' id="discountto" name="discountto"  class="input-xlarge datepick" style="width:50px;" data-rule-required="true">
                &nbsp;&nbsp;&nbsp;Enjoy
                <input type='text' id="discountrate" name="discountrate"  class="" style="width:50px;" data-rule-required="true"> &nbsp;&nbsp;&nbsp; %</div>
