        ...
        <form action="<?php echo WEB_URL_ADMIN ?>admin/addpaystaypromo/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>" method="POST" class='form-horizontal form-validate' id="bb" enctype="multipart/form-data">
            ...
            <div class="control-group">
              ...
              <div class="controls"> From
                <input type='text' id="ratefrom" name="ratefrom"  class="input-xlarge datepick" style="width:50px;" value="" data-rule-required="true">
                To
                <input type='text' id="rateto" name="rateto"  class="input-xlarge datepick" style="width:50px;" value="" data-rule-required="true">
                &nbsp;&nbsp;&nbsp;stay
                <input type='text' id="stay" name="stay"  class="" style="width:50px;" value="" data-rule-required="true"> &nbsp;&nbsp;&nbsp;pay
                <input type='text' id="pay" name="pay"  class="" style="width:50px;" value="" data-rule-required="true">
                <br/><br/>
