  ...
  <div id="main">
    <div class="container-fluid">
      ...
      <div class="box box-color box-bordered red">
        ...
        <form action="<?php echo WEB_URL_ADMIN ?>admin/addweekendpromo/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4);?>/<?php echo $this->uri->segment(5);?>" method="POST" class='form-horizontal form-validate' id="bb" enctype="multipart/form-data">
           ...
           <h5>B. Week End Stay Promotion</h5>
            ...
            <div class="control-group">
              ...
              <div class="controls"> From
                ...
                &nbsp;&nbsp;&nbsp;Enjoy
                <input type='text' id="weekendrate" name="weekendrate"  class="" style="width:50px;" value="" data-rule-required="true"> &nbsp;&nbsp;&nbsp; %
                <br/> 
