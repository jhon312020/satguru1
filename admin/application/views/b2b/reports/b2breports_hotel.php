					...
					<div class="span12">
						<div class="box">
							...
							<div class="box-content nopadding">
								<form action="<?php echo WEB_URL_ADMIN ?>b2b/b2b_reports_search" method="POST" class='form-horizontal form-column form-bordered form-validate'>
									<div class="span6">
									...
									<div class="control-group">
											...
											<div class="controls">
												<select name="agent" id="current_status" class="input-xlarge">
													<option value="">All</option>
													...
													if(isset($hotel)) { if($hotel != '') { foreach($hotel as $fl) { ?>
														<tr>
															...
															<td class='hidden-1024'><?php echo $fl->ipaddress; ?></td>
                                                            	<td class='hidden-1024'><a href="<?php echo WEB_URL_ADMIN ?>b2b/b2b_voucher/<?php echo $fl->pnr_no;?>">Voucher</a></td>
