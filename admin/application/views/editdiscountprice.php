           ...
           <h5>B. %Discount</h5>
             <div class="control-group">
              ...
              <div class="controls"> From
                <input type='text' id="pricefrom" name="pricefrom"  class="input-xlarge datepick" style="width:50px;"  value="<?php if($getdiscount-> pricefrom   != '') { echo $getdiscount->pricefrom  ; } ?>" data-rule-required="true">&nbsp;
               Till&nbsp;
                <input type='text' id="priceto" name="priceto"  class="input-xlarge datepick" style="width:50px;"  value="<?php if($getdiscount->priceto != '') { echo $getdiscount->priceto; } ?>" data-rule-required="true">
                &nbsp;&nbsp;&nbsp;Enjoy
                <input type='text' id="pricerate" name="pricerate"  class="" style="width:50px;"  value="<?php if($getdiscount->pricerate != '') { echo $getdiscount->pricerate; } ?>" data-rule-required="true"> &nbsp;&nbsp;&nbsp; %</div>
