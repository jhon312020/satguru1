			...
			<div class="container-fluid">
				<div class="page-header">
					<div class="pull-left">
						...
						<h1>Asiantravel Mapping /  <?php echo 'Hotel : '.$keycity; ?></h1>
					</div>
				...
				<div class="box box-color box-bordered red">
                            ...
                            <?php   
                                               ...
                                               <td>
                                            <div class="btn-group">	<a class="btn btn-mini tip" href="<?php echo WEB_URL_ADMIN; ?>mapping/check_hotel_mapping_citywise_asiantravel/<?php echo $related_city[$i][3]; ?>/<?php echo $asian_citycode;?>/<?php echo $asian_country_code;?>" data-original-title="Update City Mapping">  Choose Correct Permanent Data City</a>
                                        </div>
                                               </td>
