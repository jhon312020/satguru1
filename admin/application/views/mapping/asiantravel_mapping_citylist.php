		...
		<div id="main">
			<div class="container-fluid">
				<div class="page-header">
					<div class="pull-left">
						<h1>Asiantravel Mapping / Citylist</h1>
					</div>
							...
							<div class="box box-bordered">
								<div class="box-title" style="width:981px">
									<ul class="tabs tabs-left">
										<li class="active">
											<a href="#t10" data-toggle="tab">Choose Any Asiantravel City</a>
										</li>
...
<link rel="stylesheet" href="<?php print WEB_DIR;  ?>assets/autofill/css/autosuggest_inquisitor1.css" type="text/css" media="screen" charset="utf-8" />
							...
							<form action="<?php echo WEB_URL_ADMIN; ?>mapping/mapping_city_asaintravel_to_permanent" method="post"  enctype="multipart/form-data" class='validate form-horizontal'>
                            <br>
