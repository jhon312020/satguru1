...
class Hotelspro_Model extends CI_Model {
	...
	function set_crediential($api)
	{
		...
		{
	  	  	$api_info =  $query->row(); 
		   	$this->client_id = 'NkhPTm9TZVdrTTRISDA3Y0t5TlR1ZytYZWo0aFplSmpTUjlYUXBYQ3p2RmVHZUF3V2ZNckNWVW1ybmpUcEFCYQ==';
			$this->password = '';
			$this->post_url = 'http://api.hotelspro.com/4.1_test/hotel/b2bHotelSOAP.wsdl';
