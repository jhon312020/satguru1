        ...
        <div class="content_wrapper" style="box-shadow: none;">
          ...
          <div style="float:left; width:520px;">
							<div class="box-content">
								...
								<form action="<?php echo site_url(); ?>/login/agent_loginpage" method="POST" class='form-horizontal form-validate' id="bb" onsubmit="return b2clogincheck();" style="margin:0px;">
									<div class="login">
                                    <div >
										
										<div <?php /*?>class="controls"<?php */?>>
										<span style="text-transform:uppercase; font-size:14px; margin-bottom:20px; font-weight:bold; float:left; text-shadow: 2px 1px #10528d;">Login To Agent Account</span>
					  ...
					  if(isset($x) && $x != ''){?>
					   ...
					   <span style="color:#FFF;">Invalid Login Details</span>               
                        <?php }?>
                                      </div>
							  ...
							  <div class="control-group" style="float:left; ">
										<label for="pwfield"  style=" text-shadow: 2px 1px #10528d;">Password</label>
										<div >
                                        
                                        <input type="password" name="password" id="pwfield"  class="field validate[required]"  style="float:left;" />
                                       
									</div>
                                     <span id="pwd_error1" style="color:#FFF;"></span>
                                    
									</div>
									
							  <div style="float:left; margin-top:0px;">
							<input type="image" src="<?php echo base_url(); ?>assets/images/login.png" /> <?php
								if(isset($status))
								{
									echo '<span style="color:yellow; font-weight:bold;padding-left: 40px;">'.$status.'</span>';
								}
								?>
                                ...
                                <span style="font-size:15px; margin-top:20px; float:right;">Don't have a DSS Agent Account? <span style="color:#da2121; font-weight:bold; font-size:15px;">Create it now!</span>
                                <a href="<?php echo site_url()?>/account/agent_registration"><img src="<?php echo base_url(); ?>assets/images/register.png" style="margin-left:20px;" /></a> </span>
