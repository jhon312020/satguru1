...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    box-shadow: 3px 3px 3px #CBCBCB; padding:5px;">
							...
							<div class="box-content">
								...
								<form action="<?php echo site_url(); ?>/login/agent_registration" method="POST" class='form-horizontal form-validate' id="supplier_reg_form"   enctype="multipart/form-data" onsubmit="return b2clogincheck();">
    ...
    margin-top: 10px;">
									...
									<div class="control-group" style="width:480px; float:left;  margin-bottom:5px;">
										<label for="textfield" class="control-label" style="font-size:12px;">Company Name:</label>
										<div style="float:left; margin-left:10px;">
											<input type="text" name="company" id="first_name" tabindex=1 class="travller_inputbox178 fleft validate[required]" style="height:auto; float:left; width:250px;"  data-rule-required="true" data-rule-minlength="2">
									...
									<div class="control-group" style="width:480px; float:left;  margin-bottom:5px;">
										<label for="textfield" class="control-label" style="font-size:12px; ">Name:</label>
										<div style="float:left; margin-left:10px;">
											<input type="text" name="fnam" id="last_name"  tabindex=2 class="travller_inputbox178 fleft validate[required,custom[onlyLetterSp]]" style="height:auto; width:250px;"  data-rule-required="true" data-rule-minlength="2">
                                    ...
                                    <div class="control-group" style="width:480px; float:left;  margin-bottom:5px;">
									   ...
									   <div class="control-group" style="width:480px; float:left;  margin-bottom:5px;">
                                        ...
                                        <div class="control-group" style="width:480px; float:left;  margin-bottom:5px;">
										<label for="textfield" class="control-label" style="font-size:12px; ">Skype ID (optional) :</label>
										<div style="float:left; margin-left:10px;">
											<input type="text" name="skype" id="skype" tabindex=4 class="travller_inputbox178 fleft " style="height:auto; width:250px;"  >
											 <br/><span id="err_cpwfield" style="float:left; margin-left:0px;"></span>
										</div>
									</div>
									   <div class="control-group" style="width:480px; float:left;  margin-bottom:5px;">
										<label for="textfield" class="control-label" style="font-size:12px; ">Business Type:</label>
										<div style="float:left; margin-left:10px;">
											<select class="search_input_box2" tabindex=9 style=" text-indent: 0.01px; text-overflow: '';  width:265px; padding:2px;" name="b_type">
    ...
    <option value="Others">Others</option>
                                     ...
                                     <div class="control-group" style="width:480px; float:left;  margin-bottom:5px;">
										<label for="textfield" class="control-label" style="font-size:12px; ">Years in Business (Optional):</label>
										<div style="float:left; margin-left:10px;">
											<input type="text" name="y_buss" id="y_buss" placeholder="4 Years" tabindex=4 class="travller_inputbox178 fleft " style="height:auto; width:250px;"  >
											 <br/><span id="err_cpwfield" style="float:left; margin-left:0px;"></span>
										</div>
									</div>
									   <div class="control-group" style="width:480px; float:left;  margin-bottom:5px;">
										<label for="textfield" class="control-label" style="font-size:12px; ">IATA Registered:</label>
										<div style="float:left; margin-left:10px;">
											<select class="search_input_box2" tabindex=9 style=" text-indent: 0.01px; text-overflow: '';  width:265px; padding:2px;" name="iata">
...
<option value="Yes">Yes</option>
	  ...
	  <div class="control-group" style="width:480px; float:left;  margin-bottom:5px;">
                                    ...
                                    <div class="control-group" style="width:480px; float:left;  margin-bottom:5px;">
										<label for="textfield" class="control-label" style="font-size:12px; ">Agent Logo</label>
										<div style="float:left; margin-left:10px;">
										<input type="file" name="file" style="width:194px;" class="validate[required] text-input"/>
</div>
									</div>
                                    <div class="control-group" style="width:480px; float:left;  margin-bottom:5px;">
										<label for="textfield" class="control-label" style="font-size:12px; ">Office No (Optional) :</label>
										<div style="float:left; margin-left:10px;">
											<input type="text" name="office" id="office" tabindex=10 class="travller_inputbox178 fleft" style="height:auto; width:250px;"   data-rule-minlength="2">
										</div>
									</div>
                                    <div style="clear:both;"></div>
									<div class="control-group">
