            ...
            <div class="inner_wrapper" style="margin-top:20px;">
                ...
                <div style="float:left; width:1020px;">
							...
							<div >
									...
									<span style="font-size:18px;">Create your <span style="color:#da2121; font-size:16px; font-weight:bold;">DSS</span> account</span>
								 
							</div>
          <div style="float:left; width:520px;">
							<div class="box-content">
								
								<form action="<?php echo site_url(); ?>/login/member_loginpage" method="POST" class='form-horizontal form-validate' id="bb" onsubmit="return b2clogincheck();">
									<div class="login">
                                    <div >
										
										<div <?php /*?>class="controls"<?php */?>>
										<span style="text-transform:uppercase; font-size:14px; margin-bottom:20px; font-weight:bold; float:left; text-shadow: 2px 1px #10528d;">Login to My Account</span>
					  ...
					  if(isset($x) && $x != ''){?>
					   ...
					   <span style="color:#FFF;">Invalid Login Details</span>               
                        <?php }?>
							...
							<input type="image" src="<?php echo base_url(); ?>assets/images/login.png" />
							<a href="<?php echo site_url(); ?>/home/forget_password"><span style="font-size:11px; margin-top:6px; margin-left:5px; float:right; color:#63ace3; text-decoration:underline;">forgot password? </span></a>
									</div>
