...
<html xmlns="http://www.w3.org/1999/xhtml">
            ...
            <div class="inner_wrapper" style="margin-top:20px;">
                <div class="book-head-icon">
                    ...
                    <div class="book-icon11">
                        ...
                        <a href='<?php echo site_url()?>/account/mybooking' style="color:#fff;"> <div class="book-icon3">My Booking</div></a>
                    </div>
                ...
                <div class="book-content">
					...
					<form name="search_itinerary" id="search_itinerary" action="<?php echo site_url(); ?>/account/mybooking" method="post">
    ...
    padding: 5px 10px;       "><a style="color:#fff" href="<?php echo base_url(); ?>/index.php/api/booking_status/<?php echo $bookings->pnr_no; ?>/1">Check Status</a></span>
               ...
               <?php } } }?>
                    ...
                    <div class="span12">
                       <div class="right_main_bar top20" style="margin-top:15px;width: 917px;">
                    <div class="fleft left20"><img src="<?php echo base_url(); ?>assets/images/white_arrow.png" align="absmiddle"> &nbsp;Recently Completed</div>
              ...
              <tbody>
				...
				<?php 
				//echo "<pre>"; print_r($recently_completed); 
						if(isset($result_complete)) { if($result_complete != '') { foreach($result_complete as $bookings_){
            ...
            <tr>
            <td><?php echo $bookings_->pnr_no; ?></td>
             <td><?php echo $bookings_->booking_no; ?></td>
              <td><?php echo $bookings_->leadpax; ?></td>
               <td><?php echo $bookings_->product_name; ?></td>
                <td><?php echo $bookings_->api_status; ?></td>
                 <td><?php echo $bookings_->amount; ?></td>
                  <td><?php echo date('d M Y', strtotime($bookings_->voucher_date))?></td>
                  
                  <td><span class='confirm-book'><a style="color:#fff" href="<?php echo base_url(); ?>/index.php/hotel/reservation/<?php echo $bookings_->pnr_no; ?>/1">Voucher</a></span>
                  
                   <?php
				  if($bookings_->booking_status!='Cancel')
				  {
					  ?>
                      <span  style="   background-color:#FF0004;
    color: #FFFFFF;
    font-size: 12px;
    padding: 5px 10px;       "><a style="color:#fff" href="<?php echo base_url(); ?>/index.php/api/cancellation/<?php echo $bookings_->pnr_no; ?>/1">Cancel</a></span>
                      <?php
				  }
				  ?></td>
                </tr>
