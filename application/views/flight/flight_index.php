...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <!--########################## HEADER INCLUDE ##############################-->
        <?php $this->load->view('header_footer/header_flight'); ?>
        <?php /*?><script type="text/javascript" src="<?php echo base_url(); ?>assets/js/jquery-1.7.1.js"></script>
...
<link rel="stylesheet" href="<?php print base_url();  ?>assets/autofill/css/autosuggest_inquisitor.css" type="text/css" media="screen" charset="utf-8" />
 ...
 function validate_form()
 {
	 ...
	 {
		  document.getElementById("dorigin_error").innerHTML = "Please Select Travelling From";
	 ...
	 else if(ddestination == 'Type Arrival Location Here' || ddestination == '')
	 {
      ...
      <div style="position:absolute; z-index:10000; margin-left:550px; margin-top:24px;"></div>
            <div class="tabMain">
                <div class="tabs">
                  <ul style="width:auto; flat:left; padding-left:0px; ">
                        <li style="background: linear-gradient(to bottom, #f19a24 0%, #f19a24 50%, #ef6806 50%, #ef6806 100%) repeat scroll 0 0 rgba(0, 0, 0, 0);"><a href="<?php echo site_url(); ?>/home/flights" >Flights<br />
                ...
                <form name="flight_search" id="flight_search" method="POST" action="<?php echo site_url(); ?>/flights/search" onSubmit="return validate_form()">
...
<!--                                    <label>
                            ...
                            <p style="float:left;">
                                   <?php /*?><div class="radio_btn_bg"> <label>
			...
			function DropDownIndexClear(strDropdownId) {
				if (document.getElementById(strDropdownId) != null) {
					document.getElementById(strDropdownId).selectedIndex = -1;
                            ...
                            <div class="fleft">
                                <label class="label" style="color:#fff;  font-weight:bold; ">Leaving From</label> <br />
    ...
    text-indent: 0.01px; text-overflow: '';" class="search_input_box2">
    				<option value="Type Departure Location Here" class="imp_dropstyle" disabled="disabled" >Important Airports</option>
    				<?php if(isset($imp_airports)) { if($imp_airports != '') { foreach($imp_airports as $imp_air){ ?>
                    <option value="<?php echo $imp_air->imp_airport ; ?>" class="dropdown_style">
						<?php echo $imp_air->imp_airport; ?></option>
                    <?php } } } ?>
                    <option value="All Airports" class="imp_dropstyle" disabled="disabled">All Airports</option>
	    ...
	    var as_json = new AutoSuggest('dorigin', options);
                   ...
                   <br  /><span id="dorigin_error" style="color:#F00;"></span>
                            ...
                            <div class="fleft left10">
                                <label class="label" style="color:#fff;  font-weight:bold; ">Travelling to</label> <br />
    ...
    text-indent: 0.01px; text-overflow: '';" class="search_input_box2">
                ...
                <script type="text/javascript">
					...
					var as_json = new AutoSuggest('ddestination', options);
                          ...
                          <br  /><span id="ddestination_error" style="color:#F00;"></span>  </div>
                            
                            <div class="clear"></div>
                            <div class="top10 fleft">
                                <label class="label" style="color:#fff;  font-weight:bold; ">Departure</label> <br />
                                <input style="color:#70a4d1;" class="search_input_box4 required validate[required]" type="text" name="sd" id="datepicker" readonly="readonly" />
                           <br  /><span id="date_error" style="color:#F00;"></span> </div>
                            <div class="fleft left10 top10" id="return_date" style="display:none;">
                                <label class="label" style="color:#fff;  font-weight:bold; ">Return</label> <br />
                                <span id="out"><input style="color:#70a4d1;" class="search_input_box4 required validate[required]" type="text" name="ed" id="datepicker1" readonly="readonly"  /></span>
                            </div>
                            
                            <div class="clear"></div>
                            <div class="fleft top10">
                                <label class="label"  style="color:#fff;  font-weight:bold; font-size:11px; ">Adult(12+)</label> <br />
                                <select name="adult" id="s1" class="search_input_box2" style="-moz-appearance: none; -webkit-appearance: none; 
    text-indent: 0.01px; text-overflow: ''; padding:5px; height:30px; width:70px; color:#70a4d1;">
                            ...
                            <div class="fleft left10 top10">
                                <label class="label" style="color:#fff;  font-size:11px; font-weight:bold; ">Child(2-11)</label> <br />
                                <div id="child">
                                    <select id="s2" name="child" class="search_input_box2" style="-moz-appearance: none; -webkit-appearance: none; 
    text-indent: 0.01px;
    text-overflow: ''; padding:5px; height:30px; color:#70a4d1; font-size:11px; width:70px;">
                            ...
                            <div class="fleft left10 top10">
                                <label class="label" style="color:#fff;  font-weight:bold; font-size:11px; ">Infant(0-2)</label> <br />
                                <select id="s3" name="infant" class="search_input_box2" style="-moz-appearance: none; -webkit-appearance: none; 
    text-indent: 0.01px;
    text-overflow: ''; color:#70a4d1; padding:5px; height:30px;  width:70px;">
                					<option value="0">0</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                             ...
                             <div class="clear"></div>
                            <div class="fleft top10">
                                <label class="label" style="color:#fff;  font-weight:bold; ">Class</label> <br />
                                <select name="cabin" style="-moz-appearance: none; -webkit-appearance: none; 
    text-indent: 0.01px;
    text-overflow: ''; padding:5px; height:30px;; width:180px; color:#70a4d1;" class="search_input_box1" >
                ...
                <div class="box1">
                 ...
                 <h1 style="font-weight:bold; font-size:18px;">Recent Search</h1>
                    <div class="left_side_box" style="min-height:302px; padding:0px;">
                        ...
                        <div class="left_txt_area" style="margin-top:0px;">
               ...
               <h1 style="font-weight:bold; font-size:18px;">Best car deals</h1>
                    ...
                    <div class="right_txt_area"> 
                        <div class="fleft wid100" style="margin-right:10px;">
                        	<a href="#" title="<?php echo $cd->carname;?>"><img src="<?php echo base_url(); ?>admin/banner_images/<?php echo $cd->image ;?>" border="0" align="top" width="92" height="65" /></a>
                        </div>
                        <div style="cursor:pointer;  line-height:16px; font-size:12px;  "><?php $car_det = $cd->cardetails; echo substr($car_det,0,53).'...';?></div>
                    </div>
                    <?php $c++; }}}?></div>
...
.webwidget_tab .tabHead li a{font-weight: bold;text-decoration: none;color: #05407a;}
...
<!--<script type='text/javascript' src='<?php echo base_url(); ?>assets/js/jquery-1.3.2.min.js'></script>-->
       ...
       <?php /*?> <script type="text/javascript" src="http://code.jquery.com/jquery-1.9.1.min.js"></script><?php */?>
