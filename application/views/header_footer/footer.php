...
<div class="footer">
	<div class="foot-width">
		...
		<span class="social-media">
			<ul class="media-icon">
				<li><img src="<?php echo base_url(); ?>assets/images/images/fbicon.jpg" /></li>
				<li><img src="<?php echo base_url(); ?>assets/images/images/twico.jpg" /></li>
				<li><img src="<?php echo base_url(); ?>assets/images/images/googleico.jpg" /></li>
				<li><img src="<?php echo base_url(); ?>assets/images/images/inico.jpg" /></li>
			</ul>
		</span>
		</div>
		<div class="col-rgt">
			...
			<img src="<?php echo base_url(); ?>assets/images/images/logo-slide.jpg" style="margin-top:15px; " />
            ...
            <div class="wid320 fleft top10 left60">
                ...
                <div class="top10">
                    <form class="form-inline">
                        <input type="text" placeholder="Enter Your E-mail Address" id="email_sub" name="email_sub" class="newsletter_input" >
                        <span  class="newsletter_btn" onclick="" style="cursor:pointer;">Submit</span>
                    </form>
...
<div class="top10"><span><img src="<?php //echo base_url(); ?>assets/images/share/stumbleupon.png" width="30" /></span>
            ...
            <div class="wid200 fleft top10" >
                ...
                <div class="footer_txt left40">	<ul>
                        <li><a href="<?php //echo site_url(); ?>/home/hotels"> Hotels </a></li>
                        <li><a href="<?php //echo site_url(); ?>/home/flights">Flights </a></li>
        ...
        <div style="background-color:#277eb9; line-height:40px; width:100%; float:left; color:#FFF; " >
            <div class="inner_wrapper">
                <div  class="fleft">@ <?php // echo date('Y')?> DSS.com All Rights Reserved</div>
                <div class="fright">powered by DSS</div>
            </div>                                            
        </div></div>
