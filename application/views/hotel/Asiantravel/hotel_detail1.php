<?php
	...
	$hotel_details= $this->Hotel_Model->get_permanent_details_v3($id);		
...
<?php
              ...
              <div class="span12">
                  <div class=""><?php 
					...
					for($ssd=0;$ssd<count($result['HotelFacilityVas']);$ssd++)
					{
							 ...
							 echo  ''.$result['HotelFacilityVas'][$ssd].''.', ';
	...
	{
		?>
       <img width="230" src="<?php echo $result['h_images'][$im]; ?>" /> 
        <?php
	}
	?>
                        </div><div class="clear"></div>
                    ...
                    <div class="tabcontent hide" id="cont-5-1"> 
                        <div class="padding10">
                            <?php 
                                      if(isset($hotel_details->description))
                                {
                                echo '</br>';
							
                                    echo htmlspecialchars($hotel_details->description);
...
<script type="text/javascript">
                ...
                function mapLoad() {
                    if (GBrowserIsCompatible()) {
                        ...
                        var point = new GLatLng(<?php print $result['Latitude']; ?>,<?php print $result['Longitude']; ?>);
                        map.setCenter(new GLatLng(<?php print $result['Latitude']; ?>,<?php print $result['Longitude']; ?>),16);
  ...
  panoClient = new GStreetviewClient();
    panoClient.getNearestPanorama(new GLatLng(<?php print $result['Latitude']; ?>,<?php print $result['Longitude']; ?>),function(a){
    ...
    if (a.code == 200){
        ...
        var fenwayPark = new GLatLng(<?php print $result['Latitude']; ?>,<?php print $result['Longitude']; ?>);
