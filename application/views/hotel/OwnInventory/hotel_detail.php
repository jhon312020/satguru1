        ...
        <div class="bg_whight">
            <div class="padding10">
                <div class="padding5 text3">
                    ...
                    <p><!-- <b><?php //echo preg_replace("/[^a-z0-9_-]/i", " ", $hotel_details->HotelDesc); ?></b> <br> --><br><?php echo preg_replace("/[^a-z0-9_-]/i", " ",  substr($hotel_details->HotelDesc,0,200)); ?></p><div class="clr"></div>
                </div>
                        <div class="clr_space"></div>
                        <?php  
