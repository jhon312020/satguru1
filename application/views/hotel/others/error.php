...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    margin-top: 10px;">
	  ...
	  <div class="no_available" style="text-align:center;  color:red; font-size:16px; padding:25px; font-weight:bold;">There are no available hotels  for your stay.<br /><img src="<?php echo base_url(); ?>assets/images/no_hotel_img.png" width="154" height="154" /><br /><br /><div class="no_available_text" style="color:red">Sorry, we have no prices for hotels in this date range matching your criteria. One or more of your preferences may be affecting the number of exact matches found. Try searching again with a wider search criteria. <br></div></div>
