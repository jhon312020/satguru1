...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    margin-top: 10px;">
	  ...
	  <div class="no_available" style="text-align:center;  color:red; font-size:16px; padding:25px; font-weight:bold;"><?php echo $header; ?><br /><img src="<?php echo base_url(); ?>assets/images/error.png" width="154" height="154" /><br /><br /><div class="no_available_text" style="color:red"><?php echo $msg; ?> <br></div></div>
