...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    box-shadow: 3px 3px 3px #CBCBCB; padding:15px;">
							<div style="background-color:#3b1701; padding:10px; text-align:center;  color:#FFF; font-size:25px; font-weight:bold">
							  
									Oops! Sorry, Your Session Has Expiry.
    ...
    margin-top: 10px;">
	  ...
	  <div class="no_available" style="text-align:center;  color:red; font-size:16px; font-weight:bold;"><br /><br />
      <img src="<?php echo base_url(); ?>assets/images/no_hotel_img.png" width="" height="" /><br /><br /><br />
      <span style="color:#3b1701; font-size:18px">Sorry, your session timed out after a long time of inactivity, Please goto home page.</span><br /><br /></div>
